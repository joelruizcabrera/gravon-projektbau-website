    ...
    <div class="container mx-auto">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <button class="w-full bg-gray-100 hover:bg-yellow-500 hover:text-white text-gray-800 font-semibold py-3 px-6 rounded-lg transition-all duration-300 uppercase tracking-wide text-sm">
