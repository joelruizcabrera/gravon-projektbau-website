...
const iconPaths = {
  ...
  'users': 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M13 11a4 4 0 100-8 4 4 0 000 8zM23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75',
  'eye': 'M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z M12 9a3 3 0 11-6 0 3 3 0 016 0z',
  ...
  // Media & Files
  'image': 'M21 19V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2zM8.5 8.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM21 15l-5-5L5 21',
...
const iconPath = computed(() => {
  ...
  if (!path) {
    ...
    return iconPaths['alert-triangle'] // Fallback icon
  }
  return path
})
</script>